...
<div id="breadcrumb">
  ...
  <a href='#' class="current"><?php if(isset($row->menu_id)) echo 'Edit Menu'; else echo 'New Menu';?></a>
</div>
              ...
              <div class="col-lg-5"> 
                <div class="col-md-12">
                  <select class="form-control" id="location_id">
                    ...
                    <?php
                    $locat=$this->db->query("SELECT * FROM tbllocation where is_active='1' AND location_type='menu'")->result();
