                ...
                <form enctype="multipart/form-data" name="basic_validate" id="basic_validate" method="POST" action="" class="form-horizontal basic_validate">
                            ...
                            <div class=" col-lg-3"> 
                                <div class="col-md-12">
                                    <select id='location_id' class='form-control'>
                                        ...
                                        <?php
                                        $locat=$this->db->query("SELECT * FROM tbllocation WHERE is_active='1' AND location_type='banner'")->result();
                                            foreach ($locat as $me) {
                                                $se='';
                                                if(isset($data->location_id))
                                                    if($data->location_id==$me->location_id)
                                                        $se='selected';
                        ...
                        <div class="form-group">
                           ...
                           <!--  <label class='col-lg-2 control-label'>Is Active</label>
                            <div class=" col-lg-3"> 
                                <div class="col-md-2">
                                    <input type="checkbox"  class="form-control input-sm " name="is_active" id="is_active" <?php if (isset($data->is_active)){ if($data->is_active==1){ echo 'checked';} }else{ echo "checked"; } ?>>
                                </div>                   
                            </div> -->
                        </div>
