    ...
    <table class="my_table">
	    <tbody>
		    ...
		    <tr>
		        ...
		        <td colspan="6" class="kh-os">
		        	<?php echo $army->edu_degree; ?> &nbsp;&nbsp;&nbsp;<label class="for-label" id="pos_date">ភាសា : </label>
		        	<span><?php echo $army->foreign_lang; ?></span>
		        </td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		        ...
		        <td class="kh-os"><?php echo $this->m_army->get_parent_name('father', $id)->parents_name;?></td>
