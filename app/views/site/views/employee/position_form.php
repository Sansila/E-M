<div class="wrapper">
	<div class="clearfix" id="main_content_outer">
	    <div id="main_content">
	      ...
	      <!---Start form-->
	      <form id="position_register" method="POST" enctype="multipart/form-data"  action="<?php echo site_url('employee/position/save?&save=add')?>">
	      		<div class="row">
	     			<div class="col-sm-12">
	     				<div class="panel panel-default">
	     					<div class="panel-heading">
	     						<h4 class="panel-title">Position Detail</h4>
	     					</div>
	     					<div class="panel-body">
	     						<div class="row">
	     							...
	     							<div class="col-xs-6">
	     								<div class="checkbox">
	     									<label><input type="checkbox" name="teacher" value='tch' /> Teacher</label>
	     								</div>
	     							</div>
	     						</div>
	     						<div class="row">
