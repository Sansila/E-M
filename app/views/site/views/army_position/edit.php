<div class="container" style="padding-top: 20px; font-family: 'Khmer OS'">
	...
	<?php echo form_open('employee/army_position/edit/'.$army_position['army_pos_id'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="pos_name" class="col-md-4 control-label"><span class="text-danger">*</span>មុខតំណែង</label>
		<div class="col-md-8">
			<input type="text" name="pos_name" value="<?php echo $army_position['pos_name']; ?>" class="form-control" id="pos_name" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="pos_note" value="<?php echo $army_position['pos_note']; ?>" class="form-control" id="pos_note" />
		</div>
	</div>
