	    ...
	    <div id="main_content">
	      <div class="row result_info">
		    ...
		    <div class="col-xs-6" style="text-align: right">
	      	...
	      	<!---Start form-->
			<form id="contract_register" method="POST" enctype="multipart/form-data"  action="<?php echo site_url("library/book/save?save=add&m=$m&p=$p")?>">
	     		<div class="row">
	     			<div class="col-sm-12 ">
	     						...
	     						<input type="text" class="hide" name="serid" value="" id="serid">
	     							...
	     							<?php if(isset($msg))
	     								...
	     								<div class="form_sep">
			     							...
			     							<input type="text" name="name" value="" id="name" class="form-control parsley-validated" data-required="true" required data-parsley-required-message="Enter Service Name">
			     							<input type="hidden" name="contr_code_hidden" id="contr_code_hidden" value="">
			     						</div>

			     						<div class="form_sep">
			     							<label>Quantity</label>
			     							<input type="text" name="quantity" value="" id="quantity" class="form-control" data-required="true" required data-parsley-required-message="Enter Number for Quantity">
			     							<input type="hidden" name="contr_code_hidden" id="contr_code_hidden" value="">
			     						</div>
			     						<div class="form_sep">
			     							<label>Price</label>
			     						...
			     						<div class="form_sep">
			     							<label>Edition</label>
			     							<textarea class="form-control" name="edition" id="edition" data-required="true" required data-parsley-required-message="Enter Author2"></textarea>
			     						</div>
	     							...
	     							<div class="col-xs-4">
	     								<div class="form_sep">
			     							<label>Author</label>
			     							<textarea class="form-control" name="author" id="author" data-required="true" required data-parsley-required-message="Enter Author2"></textarea>
			     						</div>
	     								<div class="form_sep">
			     							<label>Author2</label>
			     							<textarea class="form-control" name="Author2" id="Author2" ></textarea>
			     						</div>
			     						<div class="form_sep">
