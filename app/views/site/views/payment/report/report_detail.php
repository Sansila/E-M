...
<body> 
			...
			<span class="top_action_button" align="right">
			...
			<div class="row">
				<div class="col-sm-12">
							 <style type="text/css"> 
									...
									.ftd{
										text-align: left;font-weight: bold; font-size: 11px; font-family: "Times New Roman", Times, serif; 
									}
							  </style>
					        <!-- header title -->
						    ...
						    <thead >
						    	<tr style="background-color: #F2F2F2; padding: 5px;font-weight: bold; font-size: 12px; font-family: "Times New Roman", Times, serif;">
						    ...
						    <tbody>
						    	<tr>
						    		<td class="ftd" rowspan="3" >Car Service</td>
						    		<td>450</td>
						    		<td>70</td>
						    		<td>280</td>
						    	...
						    	<tr>
						    		<td rowspan="3" class="ftd">Lunch Service</td>
						    		<td>220</td>
						    		<td>170</td>
						    		<td>50</td>
						    	...
						    	<tr>
						    		<td rowspan="2" class="ftd">Sport Service</td>
						    		<td>130</td>
						    		<td>100</td>
						    		<td>20</td>
						    	...
						    	<tr>
						    		<td class="ftd">Speacal Lernning Service</td>
						    		<td>180</td>
						    		<td>120</td>
						    		<td>60</td>
						    	</tr>
