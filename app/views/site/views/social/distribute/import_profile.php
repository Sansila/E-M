<div class="wrapper">
	<div class="clearfix" id="main_content_outer">
	    <div id="main_content">
	      <div class="alert alert-info"><strong>Import Family Distribution</strong></div> 
	      <div class="row">
	      	<div class="col-sm-12">
	      		<div class="panel panel-default">
	      			<div class="panel-body">
	      				<label class="alert"><?php echo $import_status?></label>
	      				<form action="<?php echo site_url('social/distribplan/importProfile')?>" method="POST" enctype="multipart/form-data">
	      					<div class="form_sep">
