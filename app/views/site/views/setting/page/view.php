							...
							foreach ($query as $row) {
								echo "
									<tr>
										...
										echo "<td align='center'>";if($row->is_show>0) echo "<img src='".site_url('../assets/images/checked.png')."'/></td>"; else echo "<img src='".site_url('../assets/images/unchecked.png')."'/></td>";
										...
										<td align='center'><a ><img rel='$row->pageid' onclick='deletepage(event);' src='".site_url('../assets/images/icons/delete.png')."'/></a></td><td> <a ><img rel='$row->pageid' onclick='updatepage(event);' src='".site_url('../assets/images/icons/edit.png')."'/></a></td>
									</tr>
