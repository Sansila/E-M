								...
								echo "
									<tr>
										...
										foreach ($this->module->getmodule() as $rowmo) {
											...
											if($this->role->getrolemodule($row->roleid,$rowmo->moduleid)>0) echo "<td align='center'><img src='".site_url('../assets/images/checked.png')."'/></td>"; else echo "<td align='center'><img src='".site_url('../assets/images/unchecked.png')."'/></td>";

										 } 
								   echo "<td align='center'><a><img rel='$row->roleid' onclick='deleterole(event);'  src='".site_url('../assets/images/icons/delete.png')."'/></a>   <a ><img  rel='$row->roleid' onclick='updaterole(event);' src='".site_url('../assets/images/icons/edit.png')."'/></a></td>
									</tr>
