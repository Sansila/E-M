	...
	<div class="clearfix" id="main_content_outer">
	    <div id="main_content">
	      <div class="row result_info col-xs-10">
		      	<div class="col-xs-6">
		      		<strong>Student Leave Preview</strong>
		      	</div>
	      	...
	      	<div class="panel-body">
		         <div class="table-responsive" id="tab_print">
		                ...
		                <table align='center' style='width:100%'>
							<thead>
								<th valign='top' align="center" style='width:80%'><h4 align="center">STUDENT LEAVE SCHOOL REPORT</h4></th> 
							</thead>
						</table>
						<table>
							<!-- <tr>
		                		...
		                		<tbody>
		                			...
		                			foreach ($data as $std) {
		                				echo "<tr>
		                					...
		                					<td>".$this->green->convertSQLDate($std->leave_sch_date)."</td>
		                					<td>".$std->leave_reason."</td>
