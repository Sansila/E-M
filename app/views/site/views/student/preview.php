	    ...
	    <div class="panel panel-default">
	      	<div class="panel-body">
		         <div class="table-responsive" id="tab_print">
		                ...
		                <table align='center'>
							<thead>
								<th valign='top' align="center" style='width:80%'><h5 align="center"><u>STUDENT PROFILE</u></h5><div style='text-align:center;'>Academic Year: <?php echo $year;?> </div></th>
								<th align='right'>
						...
						<table align='center' id='preview' style='width:100%'>
								<tr>
									...
									<td><?php echo $student['family_code']; ?></td>
