		       				...
		       				<!-- <form id="contract_register" method="POST" enctype="multipart/form-data"> -->
	     						...
	     						<div class="row">
	     							<div class="col-xs-6">
			     							...
			     							<div class="form_sep">
				     							...
				     							<select class="form-control input-sm" id="student_id">
				     								...
				     								// print_r($std);
				     									...
				     									foreach ($std as $row) {
				     										echo "<option value='$row->studentid'>$row->fullname - $row->student_num</option>";
				     									}
				     								 ?>
				     							</select>
			     						...
			     						<div class="col-xs-2">
	     									<input type="button" class="btn btn-primary btn-sm" onclick="submitatt(event);" value="Sumit">
			     						</div>
...
<script type="text/JavaScript">
	...
	function getdata(){
		var val=$("#student_id").val();
			...
			$.ajax({
				type: "POST",
				url:"<?php echo base_url(); ?>index.php/student/attendent/getdata/"+val,    
				data: {'val':val},
	...
	function submitatt(event){
		...
		$.ajax({
				type: "POST",
				url:"<?php echo base_url(); ?>index.php/student/attendent/submitdata_menaul",    
				data: {
					'val':val,
					// 'chk':chk
				},
