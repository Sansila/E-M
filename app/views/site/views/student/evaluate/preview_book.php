	    ...
	    <div class="panel panel-default">
	      	<div class="panel-body">
		         <div class="table-responsive" id="tab_print">
		                ...
		                <table align='center'>
							<thead>
								<th valign='top' align="center" style='width:80%'><h4 align="center"> <?php if($eva->evaluate_type=='Three Month') echo "លទ្ធផលនៃការសិក្សាប្រចាំ ត្រីមាសទី ".$semster." - ".$eva->eval_semester." Trimester"; elseif($eva->evaluate_type=='month') echo "​លទ្ធផលនៃការសិក្សាប្រចាំ ខែ ".$this->evaluate->khmonth($eva->month) ."- ".$eva->month; else echo "លទ្ធផលនៃការប្រឡងប្រចាំ ឆមាសទី ".$semster." - ".$eva->eval_semester." Semester";?></h4></th> 
							</thead>
						</table>
						...
						<div class="table-responsive">
							...
							<br>
							<?php
							$average=$this->evaluate->getaverage($eva->transno,$eva->evaluateid)->score/$counsub;
							 ?>
							<label class="control-label">មធ្យមភាគ/Average<?php echo " :  <strong>".$average." </strong> "; ?>ចំនាត់ថ្នាក់/Rank <?php echo ":  ".$this->evaluate->getrank($eva->transno,$eva->evaluateid)."  "; ?> និទ្ទេស/Mention <?php if($average<=10) echo " : ". $this->evaluate->getstdmention($average,$level)->mention ?></label><br><br>
