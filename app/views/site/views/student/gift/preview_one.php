	    ...
	    <div class="panel panel-default">
	      	<div class="panel-body">
		         <div class="table-responsive" id="tab_print">
		                ...
		                <table align='center'>
							<thead>
								<th valign='top' align="center" style='width:80%'><h4 align="center">Donation Report</h4>
						...
						<div class='table-responsive'>
							                  	<table class='table table-bordered table-striped' id='tblstdmention'>
							                		...
							                		<tbody id='list_donation'>
							                				<?php
							                					if(isset($row))
																foreach ($this->donate->getgifbystd($stdid,$row->transno) as $g) {
																	echo "<tr>
