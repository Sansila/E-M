		      	...
		      	<div class="col-xs-6" style="text-align: right">
			    	...
			    	<span class="top_action_button">
			    		<?php if($this->green->gAction("C")){ ?>
				    		<a href="<?php echo site_url("student/donation/add?m=$m&p=$p")?>" >
		           		...
		           		<div class="table-responsive" id="tab_print">
		           			...
		           			<table class="table">
		           				...
		           				<thead class='remove_tag'>
		           						...
		           						<th></th>
		           						<th class='col-xs-2'>
		           							<input type='text' class='form-control input-sm' id='s_name' onkeyup='search(event);'/>
		           						</th>
		           						<th class='col-xs-2'>
		           							<select class='form-control input-sm' id='s_type' onchange='search(event);'>
		           								<option value=''>----Select----</option>
						                  		<option value='SO'>Sponsor Order</option>
		           								<option value='AG'>Annual Gift</option>
		           							</select>
		           						</th>
		           						<th class='col-xs-2'>
...
<script type="text/javascript">
	...
	function search(event){
		...
		var type=$("#s_type").val();
		$.ajax({
				url:"<?php echo base_url(); ?>index.php/student/donation/search",    
				data: {'name':name,
						'type':type,
						'sort_num':sort_num,
						'classid':classid,
