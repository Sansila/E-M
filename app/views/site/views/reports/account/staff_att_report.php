                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-9 pull-right" style="text-align: right;">
                                  ...
                                  <form class="form-inline" role="form" method="get" action="<?php echo site_url('reports/staff_atten');?>">
                                        ...
                                        <div class="form-group">
                                            <label for="email">ចាប់ពីថ្ងៃ ទី </label>
                                             <div class="input-group input-tip" data-date-format="yyyy-mm-dd" id="b_date">
                                                ...
                                                <input type="text" class="form-control b_date" value="<?php echo $fdate ;?>" name="first_date" id="first_date" onclick="select()" style="width: 120px;" />
                                        ...
                                        <div class="form-group eventForm">
                                            ...
                                            <div class="input-group input-tip" data-date-format="yyyy-mm-dd" id="e_date">
                                                <span class="input-group-addon add-on"><span class="fa fa-calendar"></span></span>
                                                <input type="text" class="form-control e_date" value="<?php echo $ldate ;?>" name="last_date" id="last_date" onclick="select()" style="width: 120px;" />
                        ...
                        <div class="row" style="padding-left: 15px; padding-right: 15px;">
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4" style="text-align: center; padding-bottom: 10px; margin-top: 30px; font-family: Khmer OS Muol; font-size: 20px;">របាយការណ៍បុគ្គលិក</div>
                            ...
                            <table class="table table-bordered" style=" border-left: none;">
                                <tbody id="head">
                                    <tr>
                                        ...
                                        <!-- <th>Time</th>   -->
                                        <th >Total Work Time(H)</th>
                                        <th >Absent With permission(Times)</th>
                                        <th >Absent without permission(Times)</th>
                                        <th >Total Absent(Times)</th>
                                ...
                                <?php 
                                    ...
                                    foreach ($getrp as $filter_report) { 
                                        ...
                                        // $holidays = $this->reports_model->getholiday($filter_report->time_id,$fdate,$ldate);
                                        $permis = $this->reports_model->getallpermis($fdate,$ldate,$filter_report->emp_id);

                                        $total_hour=$this->reports_model->gettotal_hour($filter_report->emp_id,$fdate,$ldate);

                                        // $total_absent = $filter_report->dated - $holidays - ($filter_report->pre / 2);
                                ...
                                <tr>
                                    ...
                                    <td  align="center"><?php echo $total_hour->total_diff ?></td>
                                    <td  align="center"><?php echo isset($permis['awp'])?$permis['awp']:0 ?></td>
                                    <td  align="center"><?php echo isset($permis['awtp'])?$permis['awtp']:0 ?></td>
                                    <td  align="center"><?php echo (isset($permis['awp'])?$permis['awp']:0)+(isset($permis['awtp'])?$permis['awtp']:0) ?></td>
