                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 pull-right" style="text-align: right;">
                                  ...
                                  <form class="form-inline" role="form" method="get" action="<?php echo site_url('reports/mysale_report');?>">
                        ...
                        <div class="row" style="padding-left: 15px; padding-right: 15px;">
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4" style="text-align: center; padding-bottom: 10px; margin-top: 30px; font-family: Khmer OS Muol; font-size: 20px;">របាយការណ៍លក់ទំនិញ</div>
