                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 pull-right" style="text-align: right;">
                                  ...
                                  <form class="form-inline" role="form" method="get" action="<?php echo site_url('reports/expanses_report');?>">
                        ...
                        <div class="row" style="padding-left: 15px; padding-right: 15px;">
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4" style="text-align: center; padding-bottom: 10px; margin-top: 30px; font-family: Khmer OS Muol; font-size: 20px;">របាយការណ៍ចំនាយទូទៅ</div>
                            ...
                            <table class="table table-bordered" style=" border-left: none;">
                                ...
                                <?php 
                                    ...
                                    foreach ($getrp as $filter_report) {  
                                        $total = $total + $filter_report->amount;
                                ...
                                <tr>
                                    ...
                                    <td   align="center"><?php echo $filter_report->reference ?></td>
                                    <td  align="center"><?php echo $filter_report->note ?></td>
                                    <td  align="center"><?php echo number_format($filter_report->amount,2) ?></td>
                                </tr>
                                <?php } ?>
                                    <tr >
