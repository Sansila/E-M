		      	...
		      	<div class="col-xs-6" style="text-align: right">
			    	...
			    	<!-- <span class="top_action_button">
			    		<?php if($this->green->gAction("C")){ ?>
				    		<a href="<?php echo site_url('Stock/Stock/add')?>" >
...
<script type="text/javascript">
		...
		function search(event){				
				...
				$.ajax({
							url:"<?php echo base_url(); ?>index.php/stock/stockexpire/search",    
		...
		function deletestock(event){
			...
			if (r == true) {
				...
				location.href="<?PHP echo site_url('stock/stockexpire/delete');?>/"+stockid;
			} else {
