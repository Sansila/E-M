	...
	<div class="clearfix" id="main_content_outer">
	    <div id="main_content">
	      <div class="row result_info">
		      	<div class="col-xs-6">
		      		<strong id='title'>Medical Stock List</strong>
		      	</div>
								...
								foreach($tdata as $row){								
									...
									$tr.="<tr>
										 ...
										 if($this->green->gAction("D")){
											$tr.="<a><img rel=".$row['stockid']." onclick='deletestock(event);' src='".site_url('../assets/images/icons/delete.png')."'/></a>";
										 }
										 if($this->green->gAction("U")){
											$tr.="<a><img rel=".$row['stockid']." onclick='updatestock(event);' src='".site_url('../assets/images/icons/edit.png')."'/></a>";
										 }
									$tr.=" </td>
										 </tr>
										 ";										 
...
<script type="text/javascript">
		...
		function search(event){				
				...
				$.ajax({
							url:"<?php echo base_url(); ?>index.php/Stock/Stock/search",    
		...
		function deletestock(event){
			...
			if (r == true) {
				...
				location.href="<?PHP echo site_url('Stock/Stock/delete');?>/"+stockid+"?<?php echo "m=$m&p=$p" ?>";
			} else {
		...
		function updatestock(event){
				var stockid=jQuery(event.target).attr("rel");			
				location.href="<?PHP echo site_url('stock/stock/edit');?>/"+stockid+"?<?php echo "m=$m&p=$p" ?>";
		}
		function previewstock(event){				
				var stockid=jQuery(event.target).attr("rel");
				lwindow.open("<?PHP echo site_url('Stock/Stock/preview');?>/"+stockid,'_blank');
		}
		function sort(event)
		{
