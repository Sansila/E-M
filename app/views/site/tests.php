...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Telecomm Police Hello</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <link href="<?= site_url('assets/site/css/bootstrap.min.css'); ?>" rel="stylesheet" media="screen">
    <link href="<?= site_url('assets/css/font-awesome.min.css'); ?>" rel="stylesheet" media="screen">
    <link href="<?= site_url('assets/site/css/style.css?'.time()); ?>" rel="stylesheet" media="screen">
    
    <link href="https://fonts.googleapis.com/css?family=Angkor|Hanuman|Roboto|Moul|Koulen" rel="stylesheet">


    <link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/site/css/responsive.css') ?>" media="all">
    
    <link href="<?php echo site_url('assets/site/css/color.css')?>" rel="stylesheet" media="screen">
    <link href="<?php echo site_url('assets/site/css/transitions.css')?>" rel="stylesheet" media="screen">
    
    <link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/site/css/photobox.css') ?>" />
    <link href="<?php echo site_url('assets/site/css/jquery.bxslider.css')?>" rel="stylesheet" media="screen">

    <link href="<?php echo site_url('assets/owl-carousel/assets/owl.carousel.min.css')?>" rel="stylesheet"> 
    <link href="<?php echo site_url('assets/owl-carousel/assets/owl.theme.green.css')?>" rel="stylesheet">  
    <link href="<?php echo site_url('assets/site/css/parallax.css')?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo site_url('assets/css/bootstraps.min.css')?>" rel="stylesheet" type="text/css"/>
    <meta http-equiv="x-ua-compatible" content="ie=edge">
...
<!-- Bootstrap CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/bootstrap.min.css') ?>">

<!-- font-awesome & simple line icons CSS -->

<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/font-awesome.css') ?>" media="all">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/simple-line-icons.css')?>" media="all">

<!-- owl.carousel CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/owl.carousel.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/owl.theme.css')?>">
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/owl.transitions.css')?>">

<!-- animate CSS  -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/animate.css')?>" media="all">

<!-- flexslider CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/flexslider.css')?>" >

<!-- jquery-ui.min CSS  -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/jquery-ui.css')?>">

<!-- Revolution Slider CSS -->
<link href="<?php echo site_url('assets/css/meat_css/revolution-slider.css')?> " rel="stylesheet">

<!-- style CSS -->
<link rel="stylesheet" type="text/css" href="<?php echo site_url('assets/css/meat_css/style.css')?>" media="all">
    <script src="<?php echo site_url('assets/site/js/jquery-3.2.1.min.js')?>"></script>
    <script src="<?php echo site_url('assets/site/js/popper.min.js')?>"></script>
    <script src="<?php echo site_url('assets/site/js/bootstrap.min.js')?>"></script>
    <script src="<?php echo site_url('assets/css/jquerys.min.js')?>"></script>
    <script src="<?php echo site_url('assets/js/bootstraps1.min.js')?>"></script>
    <!--  start Script slide -->
    <script src="<?php echo site_url('assets/js/jssor.slider.min.js')?>"></script>
    <script src="<?php echo site_url('assets/js/jssor.slider.min2.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url()?>assets/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="<?php echo site_url('assets/ytp/jquery.youtubeplaylist.js')?>"></script>
    ...
    <style type="text/css">
        *{
        ...
        .info{color: red; text-transform: uppercase; font-size: 20px; font-weight: bold;}
        .border_info{
      ...
      .jssorb05 div, .jssorb05 div:hover, .jssorb05 .av {
        ...
        width: 16px;
        height: 16px;
        background: url('<?base_url()?>assets/img/b05.png') no-repeat;
        overflow: hidden;
        cursor: pointer;
      }
      ...
      .jssora22l, .jssora22r {
        ...
        height: 58px;
        cursor: pointer;
        background: url('<?base_url()?>assets/img/a22.png') center center no-repeat;
        overflow: hidden;
      }
      ...
      .jssora22r.jssora22rdn { background-position: -310px -31px; }
        .barb{
            height:6px; width:100%; margin-bottom:-115px;
        }   
    </style>
<style type="text/css">
    .bs-example{
            ...
            <div class="navleft-container">
              ...
              <div class="mega-menu-category">
                <ul class="nav">
                  ...
                  <li> <a href="shop_grid.html">New Arrivals</a>
                  ...
                  <li class="nosub"><a href="shop_grid.html">Meat</a></li>
                  <li class="nosub"><a href="shop_grid.html">Special Gift</a></li>
                  <li class="nosub"><a href="shop_grid.html">Deal of the Day</a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <li class="mt-root demo_custom_link_cms">
                ...
                <ul class="menu-items col-md-3 col-sm-4 col-xs-12">
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/index.html"><span>Home Version 1</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/Version2/index.html"><span>Home Version 2</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/Version3/index.html"><span>Home Version 3</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="index.html"><span>Home Version 4</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/Version5/index.html"><span>Home Version 5</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/rtl-version/index.html"><span>RTL Version</span></a></div>
                  </li>
                  <li class="menu-item depth-1">
                    <div class="title"> <a href="http://htmlmodern.justthemevalley.com/rtl-version1/index.html"><span>Home Version 1 RTL</span></a></div>
                  </li>
                </ul>
              </li>
              <li class="mt-root">
