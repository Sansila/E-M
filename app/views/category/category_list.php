...
<script type="text/javascript">
		...
		function getdata(page){
          	...
          	var url="<?php echo site_url('category/getdata')?>";
		...
		function update(event){
				...
				location.href="<?PHP echo site_url('category/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>";
		...
		function deletestore(event){
			...
			if(conf==true){
				...
				var url="<?php echo site_url('Category/delete')?>/"+storeid;
