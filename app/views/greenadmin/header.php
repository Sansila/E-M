	        						...
	        						if(count($page_mod)>0 && isset($pages[$row['moduleid']])){
	        							...
	        							foreach($page_mod as $page){
	        								...
	        								$menu.='<li class="'.$classSu.'">
	        					                        <a href="'.site_url($page_link).'?m='.base64_encode($row['moduleid']).'&p='.base64_encode($page['pageid']).'"><i class="fa '.$page['icon'].' fa-fw"></i> '.$page['page_name'].'</a>
	        					                    </li>';
	        							}
	        							$menu.='</ul>';							
	        						}
...
<html lang="en">
	...
	<body data-color="grey" class="flat">
		<div id="wrapper">
			<div id="header">
				<h1><a href="<?php echo base_url('/sys/dashboard'); ?>">Dashboard Administrator</a></h1>	
